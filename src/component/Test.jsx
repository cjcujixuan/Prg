                ...
                <div className="card-container">
                    {data.length > 0 ? (
                        filteredItems.map((user, index) => (
                            <div key={index} className={`card ${user.completed ? 'completed' : 'incomplete'}`}>
                                <h2>{user.id}</h2>
                                <h3>{user.title}</h3>
                ...
                <ul>
                    {data.length > 0 ? (
                        filteredItems.map(user => (
                            <li key={user.id} className={'card pgTwo'}>
                                <h2>{user.name}</h2>
                                <h3>{user.phone}</h3>
                                <h5>{user.email}</h5>
                                <p>{user.website}</p>
        ...
        return (
            <div>
                ...
                <div className="card-container">
                    {data.length > 0 ? (
                        filteredItems.map(user => (
                            <div key={user.id} className={`cardThree ${user.completed ? 'completed' : 'incomplete'}`}>
                                <h2>{user.id}</h2>
